...
Create a new variable "FamSize" as the sum of "Parch" and "SibSp":
...
Create a new variable "FamSize" as the sum of "Parch" and "SibSp". Then arrange by decreasing "FamSize":
